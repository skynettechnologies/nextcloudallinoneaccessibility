...
// end size position
    ...
    const iconImg = `/apps/allinoneaccessibilityapp/src/img/${settings.widget_icon_type}.svg`;
...
typeOptions.forEach((option) => {
    option.addEventListener("click", (event) => {
        ...
        sizeOptionsImg.forEach((option2) => {
            option2.setAttribute("src", "/apps/allinoneaccessibilityapp/src/img/" + ico_type + ".svg");
        });
        //custSizePreview.setAttribute("src", "/apps/allinoneaccessibilityapp/src/img/" + ico_type + ".svg");
    });
});
