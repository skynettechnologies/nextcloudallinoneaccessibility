...
Util::addScript(OCA\AllInOneAccessibilityApp\AppInfo\Application::APP_ID, 'main');
...
?>
    <link href="/apps/allinoneaccessibilityapp/src/css/bootstrap.min.css" rel="stylesheet" />
    <link href="/apps/allinoneaccessibilityapp/src/css/style.css" rel="stylesheet" />
    <style>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="header-content">
                                                        <h1 class="mb-0 text-black">
                                                            <img src="/apps/allinoneaccessibilityapp/src/img/all-in-one-accessibility-logo.svg" alt="All in One Accessibility - Skynet Technologies">
                                                        </h1>
                                                    </div>
                                                    <div class="form-text">
                                                     ...
                                                     ?><div class="col-auto mb-30">
                                                         <div
                                                             ...
                                                             <label for="edit-type-<?php echo $it;?>" class="option">
                                                                 <img src="/apps/allinoneaccessibilityapp/src/img/aioa-icon-type-<?php echo $it;?>.svg"
                                                ...
                                                <div class="col-auto mb-30">
                                                    <div
                                                        ...
                                                        <label for="edit-size-big" class="option">
                                                            <img src="/apps/allinoneaccessibilityapp/src/img/aioa-icon-type-1.svg"
    ...
    <script nonce="<?php echo $contentSecurityPolicyNonceManager->getNonce();?>" src="/apps/allinoneaccessibilityapp/src/js/jquery.min.js"></script>
    <script nonce="<?php echo $contentSecurityPolicyNonceManager->getNonce();?>" src="/apps/allinoneaccessibilityapp/src/js/aioasetting.js"></script>